...
if(WS.getElementPropertyValue(response, '[0].bResultado') == true)
{
	...
	WS.verifyElementPropertyValue(response, '[0].dFechaExpedicion', '2021-07-15T00:00:00')
	...
	WS.verifyElementPropertyValue(response, '[0].vchMensaje', 'La referencia no se encuentra autorizada o pagada por lo que no se puede realizar la asignación de formas valoradas')
