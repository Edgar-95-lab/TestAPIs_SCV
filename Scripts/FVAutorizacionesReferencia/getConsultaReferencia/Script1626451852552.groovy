...
if (WS.verifyResponseStatusCodeInRange(response, 200, 204) == true) {
    ...
    if (WS.getElementPropertyValue(response, '[0].bResultado') == true) {
		 ...
		 * */
        if (!((WS.getElementPropertyValue(response, '[0].vchRFC').toString().length() == 12) || (WS.getElementPropertyValue(
            response, '[0].vchRFC').toString().length() == 13))) {
		 ...
		 * */
        if (WS.getElementPropertyValue(response, '[0].vchIdentificacion').toString().equals('') || WS.getElementPropertyValue(
            response, '[0].vchFolioIdentificacion').toString().equals('')) {
